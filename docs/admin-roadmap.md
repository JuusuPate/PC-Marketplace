...
| 3         | Listings    | Haku, tila, myyjä, hinnat ja sivutus; perusteltu piilotus ja palautus valinnaisella perustelulla päätöslokiin                                                                                  | Kategoria-/hinta-/päivärajaukset ja ilmoituksen muiden muutosten historia.                                                                                                                          |
...
| 8         | Audit log   | Katalogimuutosten, raporttipäätösten, ilmoitusmoderoinnin ja markkinointitiedotteiden haku/sivutus; tekijä, aika, kohde, ennen/jälkeen ja olemassa oleva perustelu. Ei muokkausta tai poistoa. | Muiden tulevien toimintojen kytkeminen lokiin. Vanhoilla katalogitapahtumilla ei ole tallennettua perustelua.                                                                                       |

## V2 – laajennukset

1. **Analytics:** luontiaikaan perustuva aikavertailu sekä päivittäiset 7/30/90/180/365 vrk käyrät, nykyisten käyttäjätilien kertymä sekä katalogituotteen toteutuneiden hintojen aikavertailut on toteutettu. Molemmat kaaviomigraatiot on asennettu ja niiden lukurajapinnat tarkistettu Supabasessa 26.9.2026. Kävijä-/käyttötapahtumia ei vielä kerätä; aktiivisuutta tai konversiota ei voi päätellä nolliksi.
...
6. **Marketing:** kielikohtaisten etusivutiedotteiden luonti, julkaisu, muokkaus ja auditointi on toteutettu. Kampanja-aikataulut, kupongit, kumppanuus- ja mainoslogiikka puuttuvat. Kuponkien rahavaikutus sidotaan palvelinpuolen kassaan.
