...
| 3         | Listings    | Haku, tila, myyjä, hinnat ja sivutus; perusteltu piilotus ja palautus päätöslokiin                                                                                   | Kategoria-/hinta-/päivärajaukset ja ilmoituksen muiden muutosten historia.                                                                                                                          |
...
| 8         | Audit log   | Katalogimuutosten, raporttipäätösten ja ilmoitusmoderoinnin haku/sivutus; tekijä, aika, kohde, ennen/jälkeen ja olemassa oleva perustelu. Ei muokkausta tai poistoa. | Uusien toimintojen kytkeminen lokiin. Vanhoilla katalogitapahtumilla ei ole tallennettua perustelua.                                                                                                |
