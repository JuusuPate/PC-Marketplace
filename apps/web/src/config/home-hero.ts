/**
 * Etusivun suuren "Hyvät osat" -alueen taustakuva.
 *
 * 1. Lisää kuva kansioon apps/web/public/images/hero/.
 * 2. Kirjoita tiedoston selainpolku alle, esimerkiksi:
...
export const HOME_HERO_BACKGROUND_SIZE = "10% auto";
