...
const en = {
  ...
  usersNote:
    "Total registrations of current Finnish profiles. Deleted accounts are not included in the historical curve.",
...
const fi: typeof en = {
  ...
  usersTotal: "Kaikki käyttäjät",
  usersNote: "Nykyisten Suomen käyttäjätilien kertynyt määrä. Poistetut tilit eivät sisälly historiakäyrään.",
...
const sv: typeof en = {
  ...
  users: "Nya användare",
  usersTotal: "Alla användare",
  usersNote: "Ackumulerat antal nuvarande finländska konton. Raderade konton ingår inte i historiken.",
